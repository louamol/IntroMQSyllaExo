...
\newtcolorbox{mybox2}[2][]{colback=orange!5!white,colframe=orange!75!black,colbacktitle=orange!5!white,enhanced,attach boxed title to top center={yshift=-2mm},title={\textcolor{black}{#2}},#1}
...
\setuptodonotes{inline,bordercolor=black,textcolor=black,backgroundcolor=orange,size=\small}
...
\titleformat{\chapter}[hang]{\Huge\bfseries}{Séance \thechapter\hsp\textcolor{gray75}{|}\hsp}{0pt}{\Huge\bfseries}
